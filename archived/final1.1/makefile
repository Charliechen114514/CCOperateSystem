...
KERNEL_MAIN_OBJ = \
		...
		$(OBJ_DIR)/thread_relative_print.o $(OBJ_DIR)/buildin_cmd.o $(OBJ_DIR)/exec.o \
...
${KERNEL_MAIN_OBJ}: 
	...
	${GCC} ${KERMAIN_CFLAGS} ${USER_C_SRC_DIR}/programs/exec.c -o $(OBJ_DIR)/exec.o
	${GCC} ${KERMAIN_CFLAGS} ${USER_C_SRC_DIR}/programs/wait_exit.c -o $(OBJ_DIR)/wait_exit.o
	${GCC} ${KERMAIN_CFLAGS} ${USER_C_SRC_DIR}/ccshell/pipe.c -o $(OBJ_DIR)/pipe.o
